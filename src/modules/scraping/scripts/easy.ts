...
//         await page.waitForSelector('span.vtex-store-components-3-x-productBrand', { timeout: 10000 });
//         await page.waitForSelector('div.easycl-precio-cencosud-0-x-lastPrice', { timeout: 10000 });
